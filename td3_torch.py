...
class Agent():
    def __init__(self, alpha, beta, input_dims, tau,
            ...
            layer2_size=300, layer3_size = 300, batch_size=100, noise=0.1, chkpt_dir = 'tmp/td3'):
        self.gamma = gamma
        self.tau = tau
        self.max_action = 0.6
        self.min_action = -0.6
        ...
        self.actor = ActorNetwork(alpha, input_dims, layer1_size,
                        layer2_size, layer3_size, n_actions=n_actions, name='actor', chkpt_dir=chkpt_dir)

        self.critic_1 = CriticNetwork(beta, input_dims, layer1_size,
                        layer2_size, layer3_size, n_actions=n_actions, name='critic_1', chkpt_dir=chkpt_dir)
        self.critic_2 = CriticNetwork(beta, input_dims, layer1_size,
                        layer2_size, layer3_size, n_actions=n_actions, name='critic_2', chkpt_dir=chkpt_dir)
        self.target_actor = ActorNetwork(alpha, input_dims, layer1_size,
                    layer2_size, layer3_size, n_actions=n_actions, name='target_actor', chkpt_dir=chkpt_dir)
        self.target_critic_1 = CriticNetwork(beta, input_dims, layer1_size,
                layer2_size, layer3_size, n_actions=n_actions, name='target_critic_1', chkpt_dir=chkpt_dir)
        self.target_critic_2 = CriticNetwork(beta, input_dims, layer1_size,
                layer2_size, layer3_size, n_actions=n_actions, name='target_critic_2', chkpt_dir=chkpt_dir)
